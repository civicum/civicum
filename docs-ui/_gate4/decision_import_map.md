...
| ADR-0007 | Tipografía | `01_TOKENS.md` | UI-TOK-009 | Sección tipografía: Nunito Sans + IBM Plex Sans + IBM Plex Mono. Tier system (HIGH/MEDIUM/LOW). Budget: tier HIGH ~120KB vs UI-STP-008 ≤800KB. | ADR-0007 ACCEPTED + DOCREF S01 §3.1 (L394–396), §3.3 |
