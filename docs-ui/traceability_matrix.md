...
| UI-TOK-007 | MUST | Módulos con data-module + --module-accent / --module-bg | S01 → §2.7 → "[data-module='mi-civicum']" (L355) | CONFLICTO | ALTO | Visual regression | Ver CONFLICT-001 |
...
| UI_RULE_ID | Tipo | Regla | DOCREF | Estado | Impacto | Verificación | Notas |
|------------|------|-------|--------|--------|---------|-------------|-------|
| UI-LAY-001 | MUST | Breakpoints mobile-first: XS=360, SM=480, MD=768, LG=1024, XL=1280, 2XL=1536 | S01 → §6.1 → tabla "Breakpoints Oficiales" (L618) | CONFLICTO | ALTO | Doc review | Ver CONFLICT-002 |
...
| UI-LAY-007 | GAP | Dark mode: no hay definición de layouts/tokens para dark mode | — | GAP | ALTO | — | Ver GAP-005 |
...
| UI-NAV-008 | GAP | Falta ruta 404 | — | GAP | ALTO | — | Ver GAP-001 |
...
| UI-STP-009 | GAP | Estados loading/error no implementados en Época 1 | — | GAP | ALTO | — | Ver GAP-006 |
