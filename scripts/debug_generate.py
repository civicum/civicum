...
# --- Load real data from World Bank JSON ---
...
def main():
    ...
    for year in range(1955, 2025):
        ...
        socio['gastoculturaDeportePerCapita'] = round(expense.get('cultura_y_deporte', 0) / poblacion if poblacion > 0 else 0, 2)  # Note: typo here? should be gastoCulturaDeportePerCapita
    ...
    with open(output_path, 'w', encoding='utf-8') as f:
        ...
        for year in sorted(enriched.keys()):
            ...
            f.write('      administracion: {exp["administracion"]},')\n'
            f.write('      otros: {exp["otros"]}')\n'
            lines.append('    },')\n'
            ...
            socio_fields = [\n'
                ...
                ('gastoculturaDeportePerCapita', f'{data["gastoculturaDeportePerCapita"]}'),  # Typo here\n'
